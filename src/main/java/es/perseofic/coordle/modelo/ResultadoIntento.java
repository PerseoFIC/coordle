...
public class ResultadoIntento implements Serializable {
	...
	public ResultadoIntento(Boolean valor1, Boolean valor2, Boolean valor3, Boolean valor4,
			Boolean valor5, Boolean valor6, Boolean valor7, Integer direccion, Boolean exito) {
		this.valor1 = valor1;
		this.valor2 = valor2;
		this.valor3 = valor3;
		this.valor4 = valor4;
	...
	public ResultadoIntento(Intento intento) {
